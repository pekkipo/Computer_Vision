...
marked_damages = cv2.imread('../images/mask.jpg', 0)  # masking image. create it in paint drawing the lines
...
# It is an advanced form of interpolation that can be used to replace lost or corrupted parts of the image data.
