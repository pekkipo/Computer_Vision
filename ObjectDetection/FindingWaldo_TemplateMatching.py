...
# So what exactly is the cv2.matchTemplate function doing? Essentially,
# this function takes a sliding window of our waldo query image and slides it across our puzzle image from left to right
#  and top to bottom, one pixel at a time. Then, for each of these locations, we compute the correlation coefficient to determine how good or bad the match is.
