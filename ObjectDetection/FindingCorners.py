# Feature detection
# Corners can serve as good features


# Two methods of corner detections
# 1 Harris Corner
...
### GOOD FEATURES TO TRACK - an imporvement on Harris's method

img = cv2.imread('../images/chess.jpg')
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

# We specify the top 50 corners
corners = cv2.goodFeaturesToTrack(gray, 100, 0.01, 15)  # 100 and 15 can be adjusted to change the number of detected corners
...
# For example, if the best corner has the quality measure = 1500, and the qualityLevel=0.01 , then all the corners with the quality -
